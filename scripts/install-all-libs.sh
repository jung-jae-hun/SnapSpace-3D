...
# API dependencies
pnpm add -F @snapspace/api @nestjs/common @nestjs/core @nestjs/platform-express @nestjs/swagger @nestjs/jwt swagger-ui-express class-validator class-transformer reflect-metadata rxjs passport
